...
# def calculate_snr(signal_power, noise_db_spl, ref_pressure=20e-6):
#     """
#     Calculate Signal-to-Noise Ratio (SNR) given signal power and noise level in dB SPL.

#     Args:
#         signal_power (float): Power of the signal (linear scale).
#         noise_db_spl (float): Noise level in dB SPL.
#         ref_pressure (float): Reference pressure, default is 20 µPa.

#     Returns:
#         float: SNR in dB.
#     """
#     # Calculate Noise RMS from dB SPL
#     noise_rms = ref_pressure * (10 ** (noise_db_spl / 20))
...
# # Example values
# signal_power = 0.001224  # Signal power (linear)
# noise_db_spl = 132.17  # Noise level in dB SPL

# snr_db = calculate_snr(signal_power, noise_db_spl)
...
# # Data sinyal audio
# audio_data = np.array([-3000, 2000, -1500, 1000, 500, -1000])

# # Noise (simulasi noise kecil untuk contoh)
# noise_data = np.random.normal(0, 100, len(audio_data))  # Gaussian noise (mean=0, std=100)

# # Fungsi menghitung RMS dan Power
# def calculate_rms(audio):
#     return np.sqrt(np.mean(audio**2))

# def calculate_power(rms):
#     return rms**2

# # RMS dan Power dari sinyal
# rms_signal = calculate_rms(audio_data)
# power_signal = calculate_power(rms_signal)

# # RMS dan Power dari noise
# rms_noise = calculate_rms(noise_data)
# power_noise = calculate_power(rms_noise)

# # Menghitung SNR
# snr = 10 * np.log10(power_signal / power_noise)

# # Output
# print(f"RMS Signal: {rms_signal:.2f}")
# print(f"Power Signal: {power_signal:.2f}")
# print(f"RMS Noise: {rms_noise:.2f}")
# print(f"Power Noise: {power_noise:.2f}")
# print(f"SNR: {snr:.2f} dB")


# ####################### SAMPLE SNR FOR SIGNAL CAPTURE ################################
...
# def capture_audio(sample_rate=44100, chunk_size=1024):
#     p = pyaudio.PyAudio()
...
#     try:
#         while True:  # Continuously record until manually stopped
...
# # Example to capture signal and noise
# sample_rate = 44100  # Hz
# chunk_size = 1024  # samples

# # Capture signal (desired audio)
# signal_data = capture_audio(sample_rate, chunk_size)
# print('Signal Source Data:', signal_data)

# # Capture noise (background noise)
# # Here, we assume you capture the noise during a silent period or separately
# noise_data = capture_audio(sample_rate, chunk_size)
# print('Signal Noisse Data:', signal_data)

# # Calculate RMS for signal and noise
# signal_rms = calculate_rms(signal_data)
# print('Signal RMS Source:', signal_rms)
# noise_rms = calculate_rms(noise_data)
# print('Signal RMS Noise:', noise_rms)
